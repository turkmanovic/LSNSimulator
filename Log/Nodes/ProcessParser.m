...
ylabel(hA(1),'\textbf{Normalized energy consumption}','interpreter','latex','FontSize', 28)
set(hA(2),'yticklabel',num2str(get(hA(2),'ytick').','%.2f'))
set(hA(2),'fontsize',24)
ylabel(hA(2),'\textbf{Normalized Average Delivery Time}','interpreter','latex','FontSize', 28)
%{
