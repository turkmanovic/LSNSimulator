function x = NodeParserFunction(filename)
...
NODE_Consumption1 = cellfun(@str2double,NODE_ConsumptionCellOnly);
...
NODE_Timeset1_1 = cellfun(@str2double,NODE_TimeCellOnly1_1);
