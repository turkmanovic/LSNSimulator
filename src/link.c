...
//	}
	...
	prvCONNECTION_LIST[prvLINK_CONNECTION_NUMBERS]->countingAccess		=	0;
	prvCONNECTION_LIST[prvLINK_CONNECTION_NUMBERS]->transferEndTime		=	0;
	prvCONNECTION_LIST[prvLINK_CONNECTION_NUMBERS]->transferStartTime	=	0;
